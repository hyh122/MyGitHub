...
public class ModelChart extends AbstractDemoChart {
	...
	public View initView(double[] heartRate) {
		...
		renderer.setPanLimits(new double[] { 0, heartRate.length, heartRateCopy[0]-10, heartRateCopy[heartRateCopy.length-1]+10 }); // 设置拖动时X轴Y轴允许的最大值最小值.
		renderer.setZoomLimits(new double[] { 0, heartRate.length, heartRateCopy[0]-10, heartRateCopy[heartRateCopy.length-1]+10});// 设置放大缩小时X轴Y轴允许的最大最小值.
